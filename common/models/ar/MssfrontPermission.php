...
/**
 * This is the model class for table "{{%mssfront_permission}}".
 *
 * @property string $id
 ...
 * @property integer $can_index
 * @property string $parent_id
 */
class MssfrontPermission extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['mode', 'type', 'can_index', 'parent_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'link' => '链接地址',
            'title' => 'Title',
            'can_index' => '是否支持首页显示-1不支持，1单体版，2集团版',
            'parent_id' => '父模块id',
        ];
    }
}
